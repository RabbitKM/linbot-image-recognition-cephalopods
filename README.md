...
※ 筆者作為組長負責：照片拍攝、爬蟲、資料清洗、LINE Bot程式撰寫部屬、用戶資料視覺化
...
## ◆使用指南
### 加入好友  
<img src="https://drive.google.com/uc?export=view&id=1tcxdaZ76yEJVGWDEM4SzJkQEuHN0IUBK" height="400"> <img src="https://drive.google.com/uc?export=view&id=1siNDOjWCj1TWOvhIslcRTJUbMcPtZm_u" height="200">
...
### 實拍
* 頭城大溪漁港  
<img src="https://drive.google.com/uc?export=view&id=1hhlT24Ap1Bo4iPOY7JgIrutRjWHSnM5T" height="250"> <img src="https://drive.google.com/uc?export=view&id=1921II8HVu3PfLjS-sJ0J3k3fxKrTBAnc" height="250">  
<!-- <img src="https://drive.google.com/uc?export=view&id=1Ixng4fMi28CdM8M1CGILN9_voegnnnjt" height="250">  -->

* 室內單拍  
<img src="https://drive.google.com/uc?export=view&id=1S4xvVjzClOq7c_gZSLq6QfSjyl2Gz18t" height="250"> <img src="https://drive.google.com/uc?export=view&id=1rFMxIn7wzO4xZoYoQyK1KIBdA2zHWY7q" height="250">  
<!-- <img src="https://drive.google.com/uc?export=view&id=1uWvFYHInRM_CI29Iq4JlvyEsU3wCAcMK" height="250"> -->
...
* 爬蟲程式  
> 設定變數以調整requests參數 ([完整程式碼](https://github.com/RabbitKM/exercise-python/blob/main/web-crawler/image-search-AdobeStock.ipynb))
```
# name: 搜尋關鍵字
# limit: 每頁幾張照片(上限100)
# page: 第幾頁
...
※ 遷移學習效果卓越
VGG16僅做1個Epoch，超越CNN做82個Epoch的結果 (指Loss與Accuracy)

### 模型選用
> 挑選此三種不同架構的Model作為Base Model
* ResNet
最常用來評比Image Recognition的模型
* Inception
在縮減參數量之下，仍然可以維持Accuracy
* EfficientNet
為了在不同平台上都能夠有效運作所設計的模型  
